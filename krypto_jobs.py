...
# send_transaction
#send_transaction = send_transaction(w3, Account, receiver, wage)
...
returned_ether_balance = get_balance(w3, account.address)
...
st.sidebar.write(returned_ether_balance)
...
st.sidebar.markdown(get_people())
#get_people()
